...
class ProductFakeRepository(AbstractRepository):
    ...
    def _get_by_batchref(self, batchref):
        return next((product for product in self._products for batch in product.batches if batch.reference == batchref),
                    None)
