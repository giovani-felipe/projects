...
from src.allocation.domain.events import Event, AllocationRequired, Allocated
...
class Product:
    ...
    def allocate(self, line: OrderLine) -> str:
        try:
            ...
            self.events.append(Allocated(orderid=line.orderid, sku=line.sku, qty=line.qty, batchref=batch.reference))
